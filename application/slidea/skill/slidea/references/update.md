...
7. **What the update script does:**
   ...
   Any opt-in alternative render route lives outside the default dependency set. If you had previously set one up manually, re-follow the relevant section in the repository README after the update.
