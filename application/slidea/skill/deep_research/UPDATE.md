# Updating Deep Research

When the Deep Research skill code or dependencies change, follow this guide to update your local installation.
...
1. **Identify your Deep Research installation directory.**

This is the `<SKILLS_DIR>/deep_research` directory where you originally installed the skill.
...
3. **Export the clean skill package into the agent's local skills directory:**
   ...
   python3 "$tmp_dir/aios/application/slidea/scripts/export_skill.py" \
     --target "<SKILLS_DIR>/deep_research" --update \
