...
This repository provides [application/slidea](/application/slidea) as a sample agent application built around Capsule's design principles. Related Skills can be found in [application/slidea/skill](/application/slidea/skill).
